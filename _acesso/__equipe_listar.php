...
if (pode("13", $_COOKIE["perfil"])) {
	...
	if ($status_usuario!="") $str= "and   status_pessoa = '". $status_usuario ."' ";
...
?>
	...
	<div class="page-header">
		<h2>Equipe <small>Listando <?=$subtit;?></small></h2>
	</div>
	
	<div class="btn-group">
		<a class="btn btn-primary" href="./?pagina=acesso/equipe&amp;acao=i">Novo</a>
		...
		<ul class="dropdown-menu">
			<li><a href="./?pagina=acesso/equipe_listar&amp;status_usuario=1">Ativos</a></li>
			<li><a href="./?pagina=acesso/equipe_listar&amp;status_usuario=2">Inativos</a></li>
		</ul>
	        ...
	        <tr id="linha_<?=$rs->id_usuario;?>">
	            ...
	            <td>
		            ...
		            */
	            	...
	            	<a href="link.php?chamada=emulaUsuario&amp;id_usuario=<?=$rs->id_usuario;?>"><?= $rs->nome; ?></a> <br/>
