...
ath.intl = {
	...
	en_us: {
		message: 'Instale em seu Aparelho: Aperte em %icon e então:<br/> <strong>%action</strong>.',
		action: { ios: 'Tela de Início', android: 'Adicionar à tela de início', windows: 'Pin to Start' }
	},
